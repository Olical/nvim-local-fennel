...
local _1_
do
  local name_4_auto = "nvim-local-fennel.aniseed.fs"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  local function _5_()
    return {autoload("nvim-local-fennel.aniseed.core"), autoload("nvim-local-fennel.aniseed.nvim")}
  end
  ok_3f_21_auto, val_22_auto = pcall(_5_)
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {a = "nvim-local-fennel.aniseed.core", nvim = "nvim-local-fennel.aniseed.nvim"}}
    return val_22_auto
  else
