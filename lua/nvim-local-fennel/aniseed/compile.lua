local _0_0 = nil
do
  local name_23_0_ = "nvim-local-fennel.aniseed.compile"
...
local function _1_(...)
  ...
  return {require("nvim-local-fennel.aniseed.core"), require("nvim-local-fennel.aniseed.fs"), require("nvim-local-fennel.aniseed.nvim"), require("nvim-local-fennel.aniseed.fennel")}
end
local _2_ = _1_(...)
local core = _2_[1]
local fs = _2_[2]
