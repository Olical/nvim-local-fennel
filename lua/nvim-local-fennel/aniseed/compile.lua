...
local _1_
do
  local name_4_auto = "nvim-local-fennel.aniseed.compile"
  local module_5_auto
  do
...
local function _6_(...)
  ...
  if ok_3f_21_auto then
    _1_["aniseed/local-fns"] = {autoload = {a = "nvim-local-fennel.aniseed.core", fennel = "nvim-local-fennel.aniseed.fennel", fs = "nvim-local-fennel.aniseed.fs", nvim = "nvim-local-fennel.aniseed.nvim"}}
    return val_22_auto
  else
