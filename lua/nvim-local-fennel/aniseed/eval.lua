...
local function _1_(...)
  ...
  return {require("nvim-local-fennel.aniseed.fennel"), require("nvim-local-fennel.aniseed.core"), require("nvim-local-fennel.aniseed.compile"), require("nvim-local-fennel.aniseed.nvim"), require("nvim-local-fennel.aniseed.fs")}
end
local _2_ = _1_(...)
local fennel = _2_[1]
local core = _2_[2]
