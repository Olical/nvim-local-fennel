package.preload["nvim-local-fennel.aniseed.fennel.repl"] = package.preload["nvim-local-fennel.aniseed.fennel.repl"] or function(...)
  local utils = require("nvim-local-fennel.aniseed.fennel.utils")
  local parser = require("nvim-local-fennel.aniseed.fennel.parser")
  local compiler = require("nvim-local-fennel.aniseed.fennel.compiler")
  local specials = require("nvim-local-fennel.aniseed.fennel.specials")
...
package.preload["nvim-local-fennel.aniseed.fennel.specials"] = package.preload["nvim-local-fennel.aniseed.fennel.specials"] or function(...)
  local utils = require("nvim-local-fennel.aniseed.fennel.utils")
  local view = require("nvim-local-fennel.aniseed.fennel.view")
  local parser = require("nvim-local-fennel.aniseed.fennel.parser")
  local compiler = require("nvim-local-fennel.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "nvim-local-fennel.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["nvim-local-fennel.aniseed.fennel.compiler"] = package.preload["nvim-local-fennel.aniseed.fennel.compiler"] or function(...)
  local utils = require("nvim-local-fennel.aniseed.fennel.utils")
  local parser = require("nvim-local-fennel.aniseed.fennel.parser")
  local friend = require("nvim-local-fennel.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["nvim-local-fennel.aniseed.fennel.friend"] = package.preload["nvim-local-fennel.aniseed.fennel.friend"] or function(...)
  local function ast_source(ast)
    local m = getmetatable(ast)
    return ((m and m.line and m) or (("table" == type(ast)) and ast) or {})
  end
...
package.preload["nvim-local-fennel.aniseed.fennel.parser"] = package.preload["nvim-local-fennel.aniseed.fennel.parser"] or function(...)
  local utils = require("nvim-local-fennel.aniseed.fennel.utils")
  local friend = require("nvim-local-fennel.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["nvim-local-fennel.aniseed.fennel.view"] = package.preload["nvim-local-fennel.aniseed.fennel.view"] or function(...)
...
utils = require("nvim-local-fennel.aniseed.fennel.utils")
local parser = require("nvim-local-fennel.aniseed.fennel.parser")
local compiler = require("nvim-local-fennel.aniseed.fennel.compiler")
local specials = require("nvim-local-fennel.aniseed.fennel.specials")
local repl = require("nvim-local-fennel.aniseed.fennel.repl")
local view = require("nvim-local-fennel.aniseed.fennel.view")
...
do
  ...
  local module_name = "nvim-local-fennel.aniseed.fennel.macros"
  local _
