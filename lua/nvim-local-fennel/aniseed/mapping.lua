...
return {["aniseed/module"] = "nvim-local-fennel.aniseed.mapping", ["eval-file"] = eval_file, ["eval-range"] = eval_range, ["eval-selection"] = eval_selection, eval = eval, init = init, selection = selection}
