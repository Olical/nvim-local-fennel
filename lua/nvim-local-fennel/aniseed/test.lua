local _0_0 = nil
do
  local name_23_0_ = "nvim-local-fennel.aniseed.test"
...
local function _1_(...)
  _0_0["aniseed/local-fns"] = {require = {core = "nvim-local-fennel.aniseed.core", nvim = "nvim-local-fennel.aniseed.nvim", str = "nvim-local-fennel.aniseed.string"}}
  return {require("nvim-local-fennel.aniseed.nvim"), require("nvim-local-fennel.aniseed.core"), require("nvim-local-fennel.aniseed.string")}
end
local _2_ = _1_(...)
local nvim = _2_[1]
local core = _2_[2]
