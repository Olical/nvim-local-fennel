...
local a, fs, nvim, str = autoload("nvim-local-fennel.aniseed.core"), autoload("nvim-local-fennel.aniseed.fs"), autoload("nvim-local-fennel.aniseed.nvim"), autoload("nvim-local-fennel.aniseed.string")
