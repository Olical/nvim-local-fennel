...
local _2amodule_name_2a = "nvim-local-fennel.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("nvim-local-fennel.aniseed.core"), autoload("nvim-local-fennel.aniseed.env"), autoload("nvim-local-fennel.aniseed.eval"), autoload("nvim-local-fennel.aniseed.nvim")
