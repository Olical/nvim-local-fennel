...
[source,viml]
----
Plug 'Olical/nvim-local-fennel', { 'tag': 'v2.1.0' }
----
...
Aniseed is embedded in this plugin under the `nvim-local-fennel.aniseed.*` module prefix, this means you can use Aniseed's macros and functions in your `.lnvim.fnl` files!
